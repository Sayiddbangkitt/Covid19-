        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <a href="index.html"><img src="images/garut.jpg" alt=""></a>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="post-holder">
                                <!-- post holder -->
                                <div class="post-img"><img src="images/upacara.jpeg" alt="Free Therapy Website Template" class="img-responsive">
                                </div>
                                <div class="post-content">
                                    <!-- post content -->
                                    <div class="post-header">
                                        <h1>Panduan Pendaftaran Online Calon Siswa(i) SMK Wikrama 1 Garut </h1>
                                        <div class="meta">
                                            <!-- post meta -->
                                    ...
                                    <p>Tahun Ajaran 2020/2021 ini, Kami dari SMK Wikrama 1 Garut mulai melakukan penerimaan calon siswa(i) baru secara online.
